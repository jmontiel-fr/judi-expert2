      ...
      <form className={styles.form} onSubmit={handleSubmit} noValidate>
        ...
        <div className={styles.checkboxGroup}>
          <label className={styles.checkboxLabel}>
            ...
            <span>J&apos;accepte les <Link href="/mentions-legales">Mentions légales</Link><span className={styles.required}>*</span></span>
          </label>
          ...
          <label className={styles.checkboxLabel}>
            ...
            <span>J&apos;accepte les <Link href="/cgu">CGU</Link><span className={styles.required}>*</span></span>
          </label>
          ...
          <label className={styles.checkboxLabel}>
            ...
            <span>Je m&apos;engage à protéger les données sur mon PC (BitLocker ou équivalent)<span className={styles.required}>*</span></span>
          </label>
          ...
          <label className={styles.checkboxLabel}>
            ...
            <span>J&apos;accepte de recevoir des emails et la newsletter <span className={styles.optionalTag}>(optionnel)</span></span>
          </label>
        </div>
