...
const FAQ_DATA: FAQSection[] = [
  {
    ...
    items: [
      {
        question: "Quels sont les prérequis pour installer le Site Client ?",
        answer:
    ...
    items: [
      {
        ...
        answer:
          "Non. Toutes les données d'expertise restent exclusivement sur votre PC. Le Site Client fonctionne de manière autonome grâce aux conteneurs Docker. Seuls les tickets transitent entre votre application et le site central pour la vérification.",
      },
      {
