...
class PerformanceProfile:
    ...
    Attributes:
        ...
        dac_available: Whether the DAC (Document d'Analyse Contradictoire) service
            is available with this profile. Requires sufficient model capacity
            for long document analysis against the domain RAG corpus.
    """
