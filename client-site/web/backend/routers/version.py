...
# En développement local, il est 3 niveaux au-dessus (client-site/VERSION).
...
async def get_version():
    ...
    update_type: Optional[str] = data.get("update_type", "images")
    ...
    return LocalVersionResponse(
        ...
        mandatory=mandatory,
        update_type=update_type if update_available else None,
