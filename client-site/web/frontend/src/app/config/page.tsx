...
import MemoryLimitsSection from "@/components/MemoryLimitsSection";
...
export default function ConfigPage() {
  ...
  /* --- Tab state --- */
  const [activeTab, setActiveTab] = useState<"corpus" | "performance" | "memory">("corpus");
    ...
    <div className={styles.container}>
      ...
      {activeTab === "memory" && (
        <section className={styles.section} aria-labelledby="memory-title">
          <h2 className={styles.sectionTitle} id="memory-title">
            <span className={styles.sectionIcon} aria-hidden="true">🧮</span>
            Limites mémoire des services
          </h2>
          <MemoryLimitsSection />
        </section>
      )}
